...
async function renderSponsored(body) {
  ...
  body.innerHTML = `<div class="stack">
    <div class="card" style="padding:14px 16px;background:var(--tint-gold, rgba(233,178,19,.13));border-color:rgba(233,178,19,.4)">
      <b style="font-size:14px;color:var(--nim-deep)">How sponsorship works</b>
      <p class="tiny mt8" style="color:var(--nim-deep)">A sponsor funds a pool (e.g. 500 NIM). Top performers take the top slice; everyone who passes the final proof shares the rest. Communities fund education, learners get paid to prove it.</p>
    </div>
    ${sponsored.map((s) => `
      <div class="card" style="padding:16px">
